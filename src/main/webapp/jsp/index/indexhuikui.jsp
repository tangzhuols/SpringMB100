...
-->
  ...
  <body>
  <center>
    <form name="form1" method="post" action="/mb100/gongdan/insertGongDan.action">
      <table width="100%" height="173" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td align="right"><a href="/mb100/gongdan/endGongDan.action?wfId=<%=request.getAttribute("wfId") %>" class="style3">结束回馈工单&gt;&gt;</a>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <a href="/mb100/gongdan/selectGongdanSuoYou.action" class="style3">返回上一层&gt;&gt;</a></td>
